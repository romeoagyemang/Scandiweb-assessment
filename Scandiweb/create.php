...
<div class="container">
    <div class="d-flex pt-3">
		...
		<a href="index.php" class="btn btn-warning float-right ml-auto">Go Back</a>
	</div>
    <hr>
        ...
        <div class="col-md-12">
            ...
            <form action="add.php" method="post" name="form1" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="price" class="form-control w-50" id="price" aria-describedby="pricehelp">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input class="btn btn-secondary" type="submit" name="Submit" value="Submit" onClick="header('Location:index.php');">
                </div>
            </form>
        </div>
    </div>
